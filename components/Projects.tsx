...
async function Projects({ }: Props) {
  ...
  return (
    <MotionDiv 
        ...
        className='h-screen relative flex flex-col justify-evenly items-center overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-green-500/80 mx-auto text-left md:flex-row max-w-full z-0'>
